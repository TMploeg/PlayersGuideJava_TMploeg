...
public class Game{
	...
	private void displayRoomMessage(){
		String roomMessage =  switch(map.getCurrentRoom().getType()){
			case RoomType.ENTRANCE -> "You see light in this room coming from outside the cavern. This is the entrance.";
	...
	private void showHelp(){
		for(Command command : Command.values()){
			ConsoleHelper.printlnColor("'" + command.getCommandText() + "': " + command.getDescription(), ConsoleColor.GREEN);
		}
	}
